jQuery( document ).ready( function ( $ ) {
    ...
    function validateFields () {
        ...
        if ( $.trim( $wwpp_wr_pg_payment_gateway.val() ) == "" )
            error_fields.push( "Payment Gateways" );
        ...
        wwppBackendAjaxServices.addWholesaleRolePaymentGatewayMapping( mapping )
            .done( function ( data , textStatus , jqXHR ) {
                ...
                if ( data.status == 'success' ) {
                    ...
                    toastr.success( '' , 'Successfully Added Wholesale Role / Payment Gateway Mapping' , { "closeButton" : true , "showDuration" : successMessageDuration } );
                    ...
                    toastr.error( data.error_message , 'Failed To Add New Wholesale Role / Payment Gateway Mapping' , { "closeButton" : true , "showDuration" : errorMessageDuration } );

                    console.log( 'Failed To Add New Wholesale Role / Payment Gateway Mapping' );
                    console.log( data );
                    console.log( '----------' );
            ...
            .fail( function ( jqXHR , textStatus , errorThrown ) {
                ...
                toastr.error( jqXHR.responseText , 'Failed To Add New Wholesale Role / Payment Gateway Mapping' , { "closeButton" : true , "showDuration" : errorMessageDuration } );
        ...
        wwppBackendAjaxServices.updateWholesaleRolePaymentGatewayMapping( mapping )
            .done( function ( data , textStatus , jqXHR ) {
                ...
                if ( data.status == 'success' ) {
                    ...
                    toastr.success( '' , 'Successfully Updated Wholesale Role / Payment Gateway Mapping' , { "closeButton" : true , "showDuration" : successMessageDuration } );

                } else {

                    toastr.error( data.error_message , 'Failed To Update Wholesale Role / Payment Gateway Mapping' , { "closeButton" : true , "showDuration" : errorMessageDuration } );

                    console.log( 'Failed To Update Wholesale Role / Payment Gateway Mapping' );
                    console.log( data );
                    console.log( '----------' );
            ...
            .fail( function ( jqXHR , textStatus , errorThrown ) {
                ...
                toastr.error( jqXHR.responseText , 'Failed To Update Wholesale Role / Payment Gateway Mapping' , { "closeButton" : true , "showDuration" : errorMessageDuration } );
    ...
    $wr_pg_mapping.delegate( '.edit' , 'click' , function () {
        ...
        for ( var i = 0 ; i < currMapping.payment_gateways.length ; i++ )
            $wwpp_wr_pg_payment_gateway.find( "option[value='" + currMapping.payment_gateways[ i ] + "']" ).attr( "selected" , "selected" );
    ...
    $wr_pg_mapping.delegate( '.delete' , 'click' , function () {
        ...
        if ( confirm( 'Clicking OK will remove the current wholesale role / payment gateway mapping' ) ) {
            ...
            wwppBackendAjaxServices.deleteWholesaleRolePaymentGatewayMapping( wholesaleRoleKey )
                .done( function ( data , textStatus , jqXHR ) {
                    ...
                    if ( data.status == 'success' ) {
                        ...
                        toastr.success( '' , 'Successfully Deleted Wholesale Role / Payment Gateway Mapping' , { "closeButton" : true , "showDuration" : successMessageDuration } );

                    } else {

                        toastr.error( data.error_message , 'Failed to Delete Wholesale Role / Payment Gateway Mapping' , { "closeButton" : true , "showDuration" : errorMessageDuration } );

                        console.log( 'Failed to Delete Wholesale Role / Payment Gateway Mapping' );
                        console.log( data );
                        console.log( '----------' );
                ...
                .fail( function ( jqXHR , textStatus , errorThrown ) {
                    ...
                    toastr.error( jqXHR.responseText , 'Failed to Delete Wholesale Role / Payment Gateway Mapping' , { "closeButton" : true , "showDuration" : errorMessageDuration } );
